...
// ComponentにPropsとして渡すものをフィルタリングしたい時に使います。 

// connectの第二引数 mapDispatchToProps関数

// (LogIn)は 取得したデータをpropsとして扱うcomponentとして指定 (コンポーネント)



//onChangeTextプロパティはTextInputに入力値があるたびに発火し、引数で入力値をうけとることができます。
